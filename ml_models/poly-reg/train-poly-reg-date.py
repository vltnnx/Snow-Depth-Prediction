...
X_train = train_df[['DayOfYear', 'Year']]
y_train = train_df['Snow depth [cm]']

X_test = test_df[['DayOfYear', 'Year']]
...
# joblib.dump(model, POLY_REG_MODELS_PATH + "model-poly-reg-day-year.joblib") # Change model name in quotes
# joblib.dump(poly_features, POLY_REG_MODELS_PATH + "model-poly-reg-day-year.pkl") # Change feature name in quotes
